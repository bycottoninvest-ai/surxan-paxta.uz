# Serverni yangilash (Codex uchun) — v2.11.1
...
git pull --ff-only                                          # kutilgan: v2.11.1 commiti
docker compose up -d --build
for i in $(seq 1 40); do curl -fsS https://surxan-paxta.uz/health && break; sleep 3; done   # "version":"2.11.1"
