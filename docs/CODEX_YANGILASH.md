# Serverni yangilash (Codex uchun) — v2.12.2
...
git pull --ff-only                                          # kutilgan: v2.12.2 commiti
docker compose up -d --build
for i in $(seq 1 40); do curl -fsS https://surxan-paxta.uz/health && break; sleep 3; done   # "version":"2.12.2"
