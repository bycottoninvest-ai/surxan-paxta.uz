...
Sana: 2026-09-25. Ishga tushirish: `pytest -q` (51 test) va `python tools/perf.py`.
...
**Avtomatik testlar: 51 / 51 o‘tdi.** (PDF, arxiv navbati, migratsiya va 4 ta frontend JS tekshiruvi)
