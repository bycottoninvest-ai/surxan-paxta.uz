...
GET_PAGES = ['/', '/?view=full', '/?view=mobile', '/terim', '/telashkalar', '/tarozi', '/nakladnoylar', '/nayman',
             ...
             '/hisobot/telashkalar', '/hisobot/kombaynlar', '/hisobot/punktlar', '/hisobot/narxlar', '/hisobot/farq-sabablari', '/punkt', '/punkt/tarix', '/punkt/skaner', '/admin/punktlar', '/admin/kassalar', '/buxgalteriya', '/buxgalteriya/kirim', '/buxgalteriya/xarajat', '/buxgalteriya/xarajat/yangi?category=Ovqat', '/buxgalteriya/xarajatlar', '/buxgalteriya/ishchilar', '/buxgalteriya/tolovlar', '/kassir', '/buxgalteriya/kombaynlar', '/buxgalteriya/paxta', '/buxgalteriya/paxta?by=kun&period=mavsum', '/buxgalteriya/kassa', '/buxgalteriya/kun-yopish', '/buxgalteriya/qarzlar', '/buxgalteriya/hisobot', '/buxgalteriya/hisobot?period=mavsum&format=pdf', '/buxgalteriya/hisobot?period=oy&format=xlsx', '/hisobot/nayman', '/hisobot/tolovlar', '/hisobot/xarajatlar', '/hisobot/kassa',
             '/hisobot/mavsumlar']
...
def test_role_home_screens(app, world):
    for user, text in (('tarozi01', 'Tarozi navbati'), ('buxgalter', 'Mening kassam'),
                       ('asadbek', 'Ishchiga pul berish'), ('rahbar', 'Direktor paneli')):
